...
(function (h) {
  ...
  function B(a, b, c, d) {
    ...
    if (i === k)
      return (
        a.iDrawError != e &&
          null === j &&
          (K(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4),
          (a.iDrawError = e)),
        j
      );
    ...
    for (f = a.aoData.length; d < f; d++)
      if (((h = a.aoData[d]), !h._aFilterData)) {
        ...
        for (g = b.length; e < g; e++)
          (c = b[e]),
            c.bSearchable
              ? ((i = B(a, d, e, "filter")), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString()))
              : (i = ""),
  ...
  function Ha(a) {
    ...
    if (d || (!s && !f && !e && j == W(a) && j == n.length)) for (l = 0; l < j; l++) (i = ba(a, l)), null !== i && (c[i].sWidth = w(n.eq(l).width()));
      ...
      f && g
        ? j.width(g)
        : f
        ? (j.css("width", "auto"), j.removeAttr("width"), j.width() < k.clientWidth && m && j.width(k.clientWidth))
        : e
    ...
    for (a = 0; a < n.length; a++) {
      ...
      for (c = f.length; b < c; b++)
        (g = f[b]),
          ...
          d.push({src: i, col: g, dir: n[a][1], index: n[a]._idx, type: j, formatter: l.ext.type.order[j + "-pre"]});
    }
    return d;
  }
  function ob(a) {
  ...
  function Kb(a) {
    for (var b, c, d = a.aoColumns, e = Y(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
      ...
      c.bSortable &&
        (0 < e.length && e[0].col == f ? (i.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending" : "descending"), (c = j[e[0].index + 1] || j[0])) : (c = j[0]),
  ...
  function Ya(a, b, c) {
    ...
    for (e in b)
      b.hasOwnProperty(e) &&
        ((d = b[e]),
        h.isPlainObject(d) ? (h.isPlainObject(a[e]) || (a[e] = {}), h.extend(!0, a[e], d)) : (a[e] = c && "data" !== e && "aaData" !== e && Array.isArray(d) ? d.slice() : d));
    return a;
  }
  function Xa(a, b, c) {
    h(a)
  ...
  o("search()", function (a, b, c, d) {
    ...
    return a === k
      ...
      : this.iterator("table", function (e) {
          e.oFeatures.bFilter &&
            ha(e, h.extend({}, e.oPreviousSearch, {sSearch: a + "", bRegex: b === null ? false : b, bSmart: c === null ? true : c, bCaseInsensitive: d === null ? true : d}), 1);
        });
  });
